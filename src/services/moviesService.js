...
const API_KEY = "37f380c84b46fa72f453af5706c78a44";

// thunk function
export const getOriginals = () => async (dispatch) => {
    try {
        const response = await httpRequest.get(`discover/movie?api_key=${API_KEY}&with_networks=213`);
...
export const getTrending = () => async (dispatch) => {
    try {
        const response = await httpRequest.get(`trending/all/week?api_key=${API_KEY}&language=en-us`);
...
export const getTopRated = () => async (dispatch) => {
    try {
        const response = await httpRequest.get(`movie/top_rated?api_key=${API_KEY}&language=en-us`);
...
export const getAction = () => async (dispatch) => {
    try {
        const response = await httpRequest.get(`discover/movie?api_key=${API_KEY}&with_genres=28&language=vi`);
...
export const getComedy = () => async (dispatch) => {
    try {
        const response = await httpRequest.get(`discover/movie?api_key=${API_KEY}&with_genres=35&language=vi`);
...
export const getHorror = () => async (dispatch) => {
    try {
        const response = await httpRequest.get(`discover/movie?api_key=${API_KEY}&with_genres=27&language=vi`);
...
export const getRomance = () => async (dispatch) => {
    try {
        const response = await httpRequest.get(`discover/movie?api_key=${API_KEY}&with_genres=10749&language=vi`);
...
export const getDocumentaries = () => async (dispatch) => {
    try {
        const response = await httpRequest.get(`discover/movie?api_key=${API_KEY}&with_genres=99&language=vi`);
